package poc.activemq.in.thetaray.old.mq.producer;//package com.tr.active.mq.producer;
//
...
//
//    public int sendToQueue(final String message, final  String queueName) {
//
...
//                                        BROKER_URL_FORMAT, user, password, brokerHosts);
//                    } catch (Exception e1) {
