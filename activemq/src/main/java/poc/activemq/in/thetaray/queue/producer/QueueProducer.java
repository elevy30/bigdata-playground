package poc.activemq.in.thetaray.queue.producer;
 ...
 */
@Slf4j
class QueueProducer implements Serializable {

    void sendMessage(String[] brokerHosts, String user, String password, final String messageStr, final String queueName) {
